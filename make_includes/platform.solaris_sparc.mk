# @(#) $Revision: 4.21 $ $Source: /judy/make_includes/platform.solaris_sparc.mk $

# Makefile fragment for Judy* for platform "solaris_sparc".
# See platform.hpux_pa.mk for more comments.

# Note that not all Solaris systems have ksh.  Use the following shell instead
...
# For Solaris, $DELDIR_LIB_SUFFIX is simply null.
...
# How to echo with escaped chars expanded:
...
# Solaris manual entries are compressed a variety of ways, but bzip2 appears most
...
# Platform-specific library lists for Solaris/SPARC for various "lib" targets:
