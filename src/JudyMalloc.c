...
// #define JUDY_INS_TEST 1
#ifdef JUDY_INS_TEST
Word_t malloccnt[550];	// TBD: Correct size?
Word_t freecnt  [550];	// TBD: Correct size?
#endif
...
FUNCTION Word_t JudyMallocVirtual(
	Word_t Words)
{
