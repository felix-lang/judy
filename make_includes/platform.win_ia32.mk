# @(#) $Revision: 4.21 $ $Source: /judy/make_includes/platform.win_ia32.mk $

# Makefile fragment for Judy* for platform "win_ia32".
...
CCPATH	= /cygdrive/c/PROGRA~1/MICROS~1.NET/Vc7/bin/cl
LDPATH	= /cygdrive/c/PROGRA~1/MICROS~1.NET/Vc7/bin/link
ARPATH	= /cygdrive/c/PROGRA~1/MICROS~1.NET/Vc7/bin/lib
AR	= $(ARPATH)
AR_OPT2	= /OUT:
...
# Platform-specific library lists for Win/IA32 for various "lib" targets:
...
CC_OPTS_product = -W4 -O2
CC_OPTS_cov	= -W4 -O1 -DJU_FLAVOR_COV
CC_OPTS_debug	= -W4 -Od -DJU_FLAVOR_DEBUG
...
EXTCCOPTS = -nologo -DJU_WIN -DJU_WIN_IA32 -Dinline=__inline
