# @(#) $Revision: 4.21 $ $Source: /judy/make_includes/platform.darwin_pm.mk $

# Makefile fragment for Judy* for platform "darwin_pm".
...
LD_OPT_SL = -dynamic -flat_namespace -undefined suppress
